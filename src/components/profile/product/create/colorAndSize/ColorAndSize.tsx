...
import { ArticleIndexContext, useGlobalContext } from "../CreateContext";
...
function ColorAndSize() {
  const { articles, articleDispatch, pictures, picturesDispatch } =
    useGlobalContext();
      ...
      <div className="color-and-size-div">
        ...
        <div style={{ width: "100%", textAlign: "left" }}>
          ...
          <div style={{ width: "100%" }}>
            <SimpleInput
              text={
                articles[articleIndex].discounts[0] &&
                articles[articleIndex].discounts[0].percentage != 0
                  ? articles[articleIndex].discounts[0].percentage
                  : ""
              }
              textType="number"
              func={(text) => {
